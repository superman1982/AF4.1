...
module DeviceConsole
  ...
  def get_all_object_attrib(list_cgi, object_type, attrib_name,extern_hash={})
    ...
    if extern_hash["list_hash"] == nil
      all_objects = list_all_objects(list_cgi, object_type)
    else
      all_objects = list_all_objects(list_cgi, object_type,extern_hash["list_hash"])
    end
  ...
  def list_all_objects(list_cgi, object_type,list_hash = {"opr" =>"list"})
    post_hash = list_hash
  ...
  def list_all_objects_with_limit(list_cgi, object_type)
    list_hash = {"opr" => "list", "start" => 0, "limit" => 65535}
    return list_all_objects(list_cgi, object_type, list_hash)
  end
